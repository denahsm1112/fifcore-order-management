...
TestData excelData = findTestData('Data Files/Submit - MPF New')
...
for(int i = 1; i <= excelData.getRowNumbers(); i++) {
	...
	String salesIdInfo1 = excelData.getValue('Sales ID Info', i)
	...
	String slipGajiPasangan = excelData.getValue('Slip Gaji Pasangan', i)
	...
	String calculationMethod = 'INSTALLMENT'
	...
	String savingFolder1 = '01 New ORDER MPF/'
	...
	String savingFolder2 = '02 New CUSTOMER INFO MPF/'
	...
	String savingFolder3 = '03 New VERIFICATION ADDRESS MPF/'
	
	CustomKeywords.'id.co.fifgroup.fifcore.utilities.takeScreenCapture'(savingFolder3, fullName)
	
	//Object Info
	CustomKeywords.'id.co.fifgroup.fifcore.createOrder.objectInfoMPF'(tenor, objGroup, dealerID, objCode, price, dp, installment)

	String savingFolder4 = '04 New OBJECT FINANCE MPF/'
	
	CustomKeywords.'id.co.fifgroup.fifcore.utilities.takeScreenCapture'(savingFolder4, fullName)
	
	//General Form
	CustomKeywords.'id.co.fifgroup.fifcore.createOrder.generalMPF'(so, visitDate, vID, caCoord)
	
	String savingFolder5 = '05 New GENERAL MPF/'
	
	CustomKeywords.'id.co.fifgroup.fifcore.utilities.takeScreenCapture'(savingFolder5, fullName)
	
	//Sales Info
	CustomKeywords.'id.co.fifgroup.fifcore.createOrder.salesInfoMPF'(salesType, salesIdInfo1, salesType2, salesIdInfo2)
	
	//Upload Dokumen
	CustomKeywords.'id.co.fifgroup.fifcore.createOrder.addDocument'(ktp, ktpPasangan, slipGajiPasangan)
	
	//promo
	//CustomKeywords.'id.co.fifgroup.fifcore.createOrder.promoMPF'(calculationMethod)
	
	String savingFolder6 = '06 New SALES INFO MPF/'
	...
	String savingFolder7 = '07 New ORDER NUMBER MPF/'
