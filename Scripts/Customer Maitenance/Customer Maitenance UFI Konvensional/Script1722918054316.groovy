...
TestData excelData2 = findTestData('Data Files/Submit UFI/Customer Maintenance - UFI')
...
for(int i = 1;i <= excelData.getRowNumbers(); i++) {
	...
	String title = excelData2.getValue('Title', 1)
	String nickname = excelData2.getValue('Nickname', 1)
	String identityType = excelData2.getValue('Identity Type', 1)
	String identityNumber = excelData2.getValue('Identity Number', 1)
	String placeOfBirth = excelData2.getValue('Place Of Birth', 1)
