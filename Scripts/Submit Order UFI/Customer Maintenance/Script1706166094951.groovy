...
//GlobalVariable.customerNo = '223240001977'
//GlobalVariable.testDataCustomerMaintenance = 'Data Files/Submit Order NMC/Customer Maintenance NMC'
...
GlobalVariable.testDataCustomerMaintenance = 'Data Files/Submit UFI/Customer Maintenance - UFI'
TestData excelData = findTestData(GlobalVariable.testDataCustomerMaintenance)
...
//	GlobalVariable.teksOrder='10125002897'
//	GlobalVariable.RandomFullName='WENONA PROTEUS KESSLER'
	...
	if(RunConfiguration.getExecutionProfile()=='TEST') {
		...
		CustomKeywords.'id.co.fifgroup.fifcore.customerMaintenance.inquiryNomorOrder'(GlobalVariable.customerNo)
	}
