...
for (int i = 1; i <= excelData.getRowNumbers(); i++) {
	...
	String parentMenuInitial = 'CAP'
	String subMenuInitial = 'Receive Order'
	...
	CustomKeywords.'id.co.fifgroup.fifcore.utilities.chooseMenuAndSubMenuInvoice'(parentMenuInitial, subMenuInitial)
    ...
    CustomKeywords.'id.co.fifgroup.fifcore.createOrder.formOrder'(companyID, businessUnit, branch, platform, ojk, credit, 
        subcredit, sektor)
    //Initial Info
    CustomKeywords.'id.co.fifgroup.fifcore.createOrder.initialInfo'(nik, randomFullName, title, placeBirth, randomBirthday, namIbuRandom, 
...
TestData excelData3 = findTestData('Data Files/Submit UFI/Approve Order BU - UFI')
...
//for(int k = 1; k <= excelData3.getRowNumbers(); k++) {
	...
	String parentMenu2 = excelData3.getValue('ParentMenu' , i)
	...
	String subMenu2 = 'Credit Approval'
	String thirdMenu2 = 'Branch Approval'
	
	CustomKeywords.'id.co.fifgroup.fifcore.loginFifcore.loginIntoWeb'(GlobalVariable.url, username, password3)
	CustomKeywords.'id.co.fifgroup.fifcore.utilities.chooseMenuAndSubMenu'(parentMenu2, subMenuFirst, thirdMenuFirst)
...
//	TestData excelData4 = findTestData('Data Files/Submit UFI/Generate AR - UFI')
//	
//for(int l = 1; l <= excelData4.getRowNumbers(); l++) {
//		
//	String username4 = excelData4.getValue('Username' , l)
//	String password4 = excelData4.getValue('Password' , l)
//	String companyID = excelData4.getValue('Company' , l)
//	String businessUnit = excelData4.getValue('Business Unit' , l)
//	String branch3 = excelData4.getValue('Branch' , l)
//	String invoiceDateFrom = excelData4.getValue('Invoice Date From' , l)
//	String invoiceDateTo = excelData4.getValue('Invoice Date To' , l)
//	String parentMenu3 = 'CAP'
//	String subMenu3 = 'Contract Activation'
//	String thirdMenu3 = 'Generate AR'
//		
//	//Login Into Web
...
//	CustomKeywords.'id.co.fifgroup.fifcore.generateAR.formGenerateAR'(companyID, businessUnit, branch3,
