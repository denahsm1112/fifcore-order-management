...
TestData excelData = findTestData('Data Files/Submit Order NMC/RO - Konvensional/Create Order NMC RO')
...
for (int i = 1; i <= excelData.getRowNumbers(); i++) {
	...
	String customerNo = excelData.getValue('CustomerNo', i)
...
//    println('NIK: ' + nik)
    ...
    //Initial Info
    CustomKeywords.'id.co.fifgroup.fifcore.createOrder.initialInfoNMCRO'(nik, fullName, title, placeBirth, tglLahir, 
        namaIbu, gender, fullName, marital, occupationonId, occupation, wp, education, wpm, ojk, subOccupation, customerNo)
	


    CustomKeywords.'id.co.fifgroup.fifcore.createOrder.formVerificationAddressRO'(address, rt1, rw1, kodePos, kodePos2, occupation)
...
//        email)
    ...
    //General Form
    CustomKeywords.'id.co.fifgroup.fifcore.createOrder.general'(so, visitDate, vID, caCord)
    ...
    //Upload Dokumen
    CustomKeywords.'id.co.fifgroup.fifcore.createOrder.addDocumentNMCRO'(ktp, kk, ktpPasangan)
    ...
    //Submit Data
    CustomKeywords.'id.co.fifgroup.fifcore.createOrder.submitDataNMCRO'(ojk, occupationonId, occupation, subOccupation, address)
	
    //}
    //
    WebUI.closeBrowser()

    TestData excelData2 = findTestData('Data Files/Submit Order NMC/RO - Konvensional/Submit Struktur Kredit NMC RO')
    ...
    CustomKeywords.'id.co.fifgroup.fifcore.submitStrukturKredit.cekUserProcessNMC'(branch2, GlobalVariable.teksOrder, ddlNavigation1, 
        process)
    ...
    //MS looping
    TestData excelDataMSLooping = findTestData('Data Files/Submit Order NMC/RO - Konvensional/MS')
    ...
    //MP looping
    TestData excelDataMPLooping = findTestData('Data Files/Submit Order NMC/RO - Konvensional/MP')
    ...
    TestData excelDataOSLooping = findTestData('Data Files/Submit Order NMC/RO - Konvensional/OS')
    ...
    //}
    TestData excelData3 = findTestData('Data Files/Submit Order NMC/RO - Konvensional/Approve Order NMC RO')
    ...
    CustomKeywords.'id.co.fifgroup.fifcore.legalEntity.approvalThird'(GlobalVariable.teksOrder, statusApproval, reason, 
        comment)
    ...
    //	
    //	// Entry Invoice
    //	TestData excelData4 = findTestData('Data Files/Submit Order NMC/RO - Konvensional/Entry Invoice NMC RO')
    //	
...
//
	...
	//Generate AR
	TestData excelData4 = findTestData('Data Files/Submit Order NMC/RO - Konvensional/Generate AR NMC RO')
	...
	for(int l = 1; l <= excelData4.getRowNumbers(); l++) {
		...
		String companyIDGAR = excelData4.getValue('Company' , l)
		String businessUnitGAR = excelData4.getValue('Business Unit' , l)
		...
		//Generate AR
		CustomKeywords.'id.co.fifgroup.fifcore.generateAR.formGenerateAR'(companyIDGAR, businessUnitGAR, branch,
